<?php include('include/top.php'); ?>
			...
			<div data-role="content">
				...
				<h2>FoxFeed Blog</h2>
					<p class="mb2em">The latest reporting and analysis on breakthroughs in Parkinson's research and issues that matter most to you.</p>

				<ul data-role="listview" class="blogFeed" data-icon="false">
					<li><a data-transition="slide" href="blog-detail.php">

						<p>
							<img class="blogImage" src="images/babyFox2.jpg"  />
						</p>
					...
					<li><a data-transition="slide" href="blog-detail.php">
						<p>
							<img class="blogImage" src="images/BOROStudzinskiFamily.jpg"  />
						</p>
					...
					<li>
						...
						<p>
							<img class="blogImage" src="images/Capitol-Building.jpg"  />
						</p>
					...
					<li>
						<a data-transition="slide" href="blog-detail.php">
						<p>
							<img class="blogImage" src="images/davidweiner.jpg"  />
						</p>
					...
					<li>
						<a data-transition="slide" href="blog-detail.php">
						<p>
							<img class="blogImage" src="images/Carey-Christensen.jpg"  />
						</p>
					...
					<li>
						<a href="#comingsoon2" class="loadMorePosts" data-rel="popup" data-transition="slidedown" data-position-to="window" data-role="button" data-iconpos="bottom" data-theme="a" data-icon="arrow-d">Load More Posts</a>
					</li>
				</ul>
